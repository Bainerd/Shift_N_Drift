...
import static ShiftNDrift.gameobjects.LevelObject.*;
...
public class LevelInfo {
    ...
    public static final int   PIXELS_PER_TILE   = ShiftNDrift.utils.Config.gameWidth / SCREEN_TILES_WIDE;

    public Pool<Rectangle>                  rectanglePool;
    public Array<ShiftNDrift.utils.LevelBoundry>              tiles;
    public ShiftNDrift.utils.Level details;
    public TiledMap                         map;
    ...
    public ObjectMap<String, Array<ShiftNDrift.gameobjects.Rope>>   ropeGroups;
    public ObjectMap<String, Array<ShiftNDrift.gameobjects.TriggerableEntity>>   triggeredByRopeGroup;
    ...
    public void createLevel(int level, Pool<Rectangle> rectanglePool) {
        ...
        this.details = ShiftNDrift.utils.Level.values()[level];
        this.rectanglePool = rectanglePool;
        this.tiles = new Array<ShiftNDrift.utils.LevelBoundry>();
        this.ropeGroups = new ObjectMap<String, Array<ShiftNDrift.gameobjects.Rope>>();
        this.triggeredByRopeGroup = new ObjectMap<String, Array<ShiftNDrift.gameobjects.TriggerableEntity>>();
    ...
    public void loadMap(String mapName){
        ...
        mapRenderer = new OrthogonalTiledMapRenderer(map, MAP_UNIT_SCALE, ShiftNDrift.utils.Assets.batch);
    ...
    public void nextLevel() {
        levelIndex++;
        if (levelIndex < ShiftNDrift.utils.Level.values().length) {
    ...
    public ShiftNDrift.utils.WindField getWindBounds(Vector2 direction, Rectangle bounds){
        int x1, y1, x2, y2;
        ...
        while(tempX1 >= 0 && tempX1 < foregroundLayer.getWidth() && tempX2 >= 0 && tempX2 < foregroundLayer.getWidth() &&
            ...
            for (ObjectBase obj : mapObjects){
                if (!(obj instanceof ShiftNDrift.gameobjects.Door)) continue;
