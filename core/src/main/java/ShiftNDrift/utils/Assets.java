...
import ShiftNDrift.ParticleSystem.ParticleManager;
import ShiftNDrift.utils.accessors.*;
...
public class Assets {
    ...
    public static Animation<TextureRegion> balloonToBalloonAnimation;
    public static Animation<TextureRegion> balloonToRocketAnimation;
    public static Animation<TextureRegion> balloonToWeightAnimation;
    public static Animation<TextureRegion> balloonToMagnetAnimation;
    public static Animation<TextureRegion> balloonToBuzzsawAnimation;
    public static Animation<TextureRegion> balloonToTorusAnimation;
    public static Animation<TextureRegion> balloonToPopAnimation;
    public static Animation<TextureRegion> buzzsawAnimation;

    public static Animation<TextureRegion>[] birdAnimations; // This one is already correct

    public static Animation<TextureRegion> netAnimation;
    public static Animation<TextureRegion> fanAnimation;
    ...
    public static int getMaxLevelCompleted() {
        if (ShiftNDrift.Main.game.resolver.unlockAll()){
